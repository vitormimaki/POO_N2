...
public class LoginDAO implements DAO<Login> {
    ...
    private Login login; //meu MODEL   
    
    @Override
    public boolean insere(Login obj) throws SQLException {
        ...
        //associar os dados do objeto com o comando INSERT
    ...
    @Override
    public boolean remove(Login obj) throws SQLException {
        String sql = "DELETE FROM Login WHERE id_login = ?"; //a ? indica parametros
        ...
        //associar os dados do objeto com o comando DELETE
        pst.setInt(1, obj.getId_login());
    ...
    @Override
    public boolean altera(Login obj) throws SQLException {
        String sql = "UPDATE Login SET senha = ? "
                   + "WHERE id_login = ?"; //a ? indica parametros
        ...
        //associar os dados do objeto com o comando UPDATE
        pst.setString(1, obj.getSenha());
        pst.setInt(2, obj.getId_login());
     ...
     */
    @Override
    public Login buscaID(Login obj) throws SQLException {
